...
ActiveRecord::Schema.define(version: 2023_07_14_042544) do
  ...
  create_table "payments", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["postage_id"], name: "index_payments_on_postage_id"
  end
  ...
  create_table "postages", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["item_id"], name: "index_postages_on_item_id"
  ...
  add_foreign_key "payments", "postages"
